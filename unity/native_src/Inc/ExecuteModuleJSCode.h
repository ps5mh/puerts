...
"        if(loader.ReadFileRaw) {                                                                   \n"
"            const code = loader.ReadFileRaw(specifier, debugpathRef);                              \n"
"            if (code != null) {                                                                    \n"
"               return code;                                                                        \n"
"            }                                                                                      \n"
"        }                                                                                          \n"
"        if (loader.ReadFileBytes) {                                                                \n"
"            const code = loader.ReadFileBytes(specifier, debugpathRef);                            \n"
"            if (code != null) {                                                                    \n"
"               return code;                                                                        \n"
"            }                                                                                      \n"
"        } else if (loader.ReadFile) {                                                              \n"
